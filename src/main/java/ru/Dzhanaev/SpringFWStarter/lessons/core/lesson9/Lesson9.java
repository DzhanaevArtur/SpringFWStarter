package ru.Dzhanaev.SpringFWStarter.lessons.core.lesson9;
...
public class Lesson9 {
    ...
    public static void main(String[] args) {
        ClassPathXmlApplicationContext c = new ClassPathXmlApplicationContext("lessons/core/lesson9/lesson9.xml");
